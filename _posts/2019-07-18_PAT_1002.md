...
* # 一、题目含义
    ...
    * $A=N_{k_a}\times a_k+N_{{k-1}_a}\times a_{k-1}+...N_{1_a}\times a_1$
    * $B=N_{k_b} \times a_k+N_{{k-1}_b}\times a_{k-1}+...N_{1_b}\times a_1$
    * $A+B=(N_{k_a}+N_{k_b}) \times a_k+(N_{{k-1}_a}+N_{{k-1}_b})\times a_{k-1}+...(N_{1_a}+N_{1_b})\times a_1$
